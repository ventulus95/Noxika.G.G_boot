...
public class ParticipantStatsDto {
    ...
    private int perk1Var1;        //Post game rune stats.
    private int perk1Var3;        //Post game rune stats.
    private int perk1Var2;    //Post game rune stats.
    private int tripleKills;
    private int perk3Var3;    //Post game rune stats.
    private int nodeNeutralizeAssist;
    private int perk3Var2;    //Post game rune stats.
    ...
    private int item4;
    private int item5;
    private int perk1;        //Primary path rune.
    private int perk0;        //Primary path keystone rune.
    private int perk3;        //Primary path rune.
    private int perk2;    //Primary path rune.
    private int perk5;    //Secondary path rune.
    private int perk4;        //Secondary path rune.
    private int perk3Var1;        //Post game rune stats.
    ...
    private int perkPrimaryStyle; //Primary rune path
    ...
    private int perkSubStyle;        //Secondary rune path
    ...
    private int perk0Var1;        //Post game rune stats.
    private int perk0Var2;        //Post game rune stats.
    private int perk0Var3;        //Post game rune stats.
    ...
    public ParticipantStatsDto(boolean firstBloodAssist, long visionScore, long magicDamageDealtToChampions, long damageDealtToObjectives, int totalTimeCrowdControlDealt, int longestTimeSpentLiving, int perk1Var1, int perk1Var3, int perk1Var2, int tripleKills, int perk3Var3, int nodeNeutralizeAssist, int perk3Var2, int playerScore9, int playerScore8, int kills, int playerScore1, int playerScore0, int playerScore3, int playerScore2, int playerScore5, int playerScore4, int playerScore7, int playerScore6, int perk5Var1, int perk5Var3, int perk5Var2, int totalScoreRank, int neutralMinionsKilled, long damageDealtToTurrets, long physicalDamageDealtToChampions, int nodeCapture, int largestMultiKill, int perk2Var2, int perk2Var3, int totalUnitsHealed, int perk2Var1, int perk4Var1, int perk4Var2, int perk4Var3, int wardsKilled, int largestCriticalStrike, int largestKillingSpree, int quadraKills, int teamObjective, long magicDamageDealt, int item2, int item3, int item0, int neutralMinionsKilledTeamJungle, int item6, int item4, int item5, int perk1, int perk0, int perk3, int perk2, int perk5, int perk4, int perk3Var1, long damageSelfMitigated, long magicalDamageTaken, boolean firstInhibitorKill, long trueDamageTaken, int nodeNeutralize, int assists, int combatPlayerScore, int perkPrimaryStyle, int goldSpent, long trueDamageDealt, int participantId, long totalDamageTaken, long physicalDamageDealt, int sightWardsBoughtInGame, long totalDamageDealtToChampions, long physicalDamageTaken, int totalPlayerScore, boolean win, int objectivePlayerScore, long totalDamageDealt, int item1, int neutralMinionsKilledEnemyJungle, int deaths, int wardsPlaced, int perkSubStyle, int turretKills, boolean firstBloodKill, long trueDamageDealtToChampions, int goldEarned, int killingSprees, int unrealKills, int altarsCaptured, boolean firstTowerAssist, boolean firstTowerKill, int champLevel, int doubleKills, int nodeCaptureAssist, int inhibitorKills, boolean firstInhibitorAssist, int perk0Var1, int perk0Var2, int perk0Var3, int visionWardsBoughtInGame, int altarsNeutralized, int pentaKills, long totalHeal, int totalMinionsKilled, long timeCCingOthers) {
